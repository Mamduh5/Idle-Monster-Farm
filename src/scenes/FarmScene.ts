...
import type { CurrencyState } from '../types/game-state';
...
export class FarmScene extends Phaser.Scene {
  ...
  private createFarmGrid(): void {
    ...
    const totalHeight = GRID_ROWS * CELL_SIZE + (GRID_ROWS - 1) * GRID_GAP;
  ...
  private createHatchArea(): void {
    ...
    this.add.rectangle(x, y, panelWidth, panelHeight, 0x2f2a45, 0.9)
      .setOrigin(0)
